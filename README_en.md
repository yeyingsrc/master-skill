...
🎯 &nbsp;**New to a field** and don't know where to start? Senior practitioners' tacit knowledge isn't in any book.<br>
📰 &nbsp;**Information scattered** across a dozen newsletters, dozens of podcasts, a handful of group chats — always playing catch-up?<br>
🤖 &nbsp;**Stuffed every PDF in a field** into an AI, and it still sounds like an outsider — because "wiki ≠ how this field thinks"?
...
**Distilling more than a person — distilling an entire industry.**

One skill packs four things:
...
Tell it your sub-niche. 30-60 minutes later you get an installable skill. Drop into any AI agent — **instantly enter "the senior practitioner of that field" mode.**

<br>

[🚀 Install](#-install) · [✨ Demo](#-demo) · [🛠️ Not just talk](#️-not-just-talk--cli-tool-stream-v06) · [🧬 Lineage](#-lineage) · [⭐ Distilled industries](#-distilled-industries)
...
> 📢 &nbsp;**2026.05.02 · v1.1 release** — generated skills don't just talk; they ship with a bash command suite. [Release notes →](https://github.com/voidborne-d/master-skill/releases/tag/v1.1)
>
> 🔥 &nbsp;**2026.05.02 · v1.0 public** — first complete industry (LLM agent infrastructure) verified end-to-end.
