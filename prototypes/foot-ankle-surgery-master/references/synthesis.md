# 足踝外科 Master OS — Synthesis (deep)

> 调研日期: 2026-05-03 (deep upgrade). **严肃声明**: 本 skill 给的是资深医生的认知框架, **绝不替代执业医生临床判断**. 任何具体患者必须由执业医生面诊 + 完整评估再决定方案. 急诊 / 重大病变请走正规医疗渠道 (国内 120, 美国 911).
...
- **输出格式**: 临床假设 (1-3 个鉴别诊断, 按可能性排序) + 风险评估 (BMI / 糖尿病 / 吸烟 / 依从性)
...
- **输出格式**: 哪些是病因 / 哪些是 incidental finding, 跟临床假设是否一致
...
- **输出格式**: 期望写进病历 + 知情同意 + 长期随访计划 (X 线节点 / 评分量表 / PT 介入)
- **Last_updated**: 2025-10
- **Decay risk**: low
...
- Synthesis date: 2026-05-03 (deep)
- Source counts: total ~110 (deep)
- Primary ratio: ~78%
- Mental models: 5 (multi-figure consensus 全 ≥ 4 figures)
- Playbook rules: 9 (含案例)
- Agentic Protocol dimensions: 5 (含 Last_updated + Decay risk)
- Sub-skills: 3 (张建中 + Glazebrook + Hintermann)
