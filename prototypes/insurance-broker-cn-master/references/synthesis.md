# Synthesis — 中国保险经纪人 / 代理人 (从业者视角) 行业 OS 提炼
...
```
prototypes/insurance-broker-cn-master/
├── intake.json                       # Phase 0
├── output/
│   ├── references/
│   │   ├── synthesis.md             # 本文件
│   │   ├── synthesis-candidates.md  # raw candidates (省略 — 嵌入本文 evidence)
│   │   └── research/
│   │       ├── 01-figures.md
│   │       ├── 02-tools.md
│   │       ├── 03-workflows.md
...
│   │       ├── 06-glossary.md
│   │       └── seeds/
│   │           └── podcast_episodes.jsonl  # collectors 输出
│   ├── (Phase 3 → SKILL.md / meta.json / cli/)
│   └── (Phase 3 → sub-skills/)
└── (Phase 4 → references/quality-check-rubric.md / claim-verifier-report.md)
```