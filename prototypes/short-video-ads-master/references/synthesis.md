...
- **输出格式**: 4 项各 score (1-10) + 1 句最大瓶颈

### 9.2 学习期判断

- **看什么**: 计划当前转化数 + 关键指标趋势
- **在哪看**: 巨量千川后台 + 巨量数据云
- **输出格式**: 学习期 / 稳定期 / 衰减期 三级 + 推荐动作 (不动 / 优化 / 砍掉)

### 9.3 出价 / ROAS 性价比

- **看什么**: 类目当前 CPC / CPM / ROAS benchmark vs 自家计划
- **在哪看**: 蝉妈妈 / 蝉小红 + 巨量千川后台
- **输出格式**: ROAS 区间 + 是否值得继续投 + 推荐 OCPM 出价范围

### 9.4 5A 人群健康度评估 (中大品牌)

- **看什么**: 5A 人群增长 / 标签丰富度 / LTV / 跨阶段人群迁移
- **在哪看**: 巨量数据云 5A 人群分析
- **输出格式**: 5 类人群健康度评分 + 主攻人群推荐

### 9.5 跨平台 ROI 归因

- **看什么**: 抖音种草 + 小红书 AIPS + 微信私域 + 天猫旗舰店 跨平台贡献
- **在哪看**: 抖音 5A + 小红书 AIPS + 微信私域 BI
- **输出格式**: 跨平台 ROI 占比 + 重点扩 5A → P (购买) 的人群 + 调整建议
...
- Workflows: 5
- Tools: 18 (5 必备 + 7 场景特化 + 6 新兴)
- Concepts: 97 (60 术语 + 15 规则 + 10 指标 + 12 跨平台对照)
