# 跨境电商运营 Master OS — Synthesis (深度版)

> Phase 2 提炼结果. 深度版 (vs mini scope), 基于 6 路 research (figures / tools / workflows / canon / sources / glossary) 总 1700+ 行真实调研.

## 元数据
- 调研日期: 2026-05-02
- Source counts: 70+ (Primary 50+, Secondary 15, Reference 5)
- Primary ratio: 71%
- Mental models: 5 (3 PASS + 2 industry-amplified)
- Playbook rules: 9
...
- **输出格式**: 类目机会 score (1-10) + 1 句关键瓶颈 + 推荐细分
...
- **输出格式**: low / medium / high 合规风险等级 + 必做清单 + 估算成本 / 时间
...
- **输出格式**: 关键词金字塔 (高 / 中 / 长尾) + Listing 优化方向
...
- **输出格式**: 预期 ACOS 区间 + 是否值得投 + 1 句获利节奏判断
...
- **输出格式**: 财务健康度 (1-10) + payback 周期 + 资金周转风险点
...
- Source counts: total 70+ (51 Primary / 15 Secondary / 5 Reference)
- Primary ratio: 71%
- Cumulative findings: 5 心智模型 (3 PASS + 2 industry-amplified) / 9 playbook / 5 protocol 维度 / 4 完整工作流
- Cross-track contradictions: 主要分歧已在智识谱系节明确 (品牌 vs 套利 / 数据派 vs 经验派 / Amazon 单押 vs 多平台)

## 流派代表性长访谈 / 长篇

- 阳萌 (Anker) 在腾讯新闻的 247 亿出海巨头深度对话 (2025-09)
- Steve Chou MWQHJ E612 「最聪明的电商创始人课」
- Andrew Youderian 「11 Predictions for 2026」
- Bradley Sutton Helium 10 Serious Sellers Podcast 多期 2025-2026 SOP
- Marketplace Pulse Walmart Marketplace 200k+ 卖家年度报告
