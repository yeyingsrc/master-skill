...
USAGE:
  ./seo.sh             # interactive
  ./seo.sh --dry-run   # walk through but no file
  ./seo.sh --json      # JSON to stdout
  ./seo.sh --explain   # show backing playbook rules + mental models
  ./seo.sh --help      # this message
EOF
}
