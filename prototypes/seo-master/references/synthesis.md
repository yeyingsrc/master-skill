# SEO Master OS — Synthesis (深度版)

> Phase 2 提炼. 5 个心智模型 + 9 条决策规则 + 5 个 Agentic Protocol 维度. 一手比例 ≥ 70%.
...
- Source counts: total 80+ (deep)
- Primary ratio: 70%+
- Mental models: 5 (2 PASS + 3 industry-amplified)
- Playbook rules: 9
- Agentic Protocol dimensions: 5
- Workflows: 5
- Tools: 19+ (5 必备 + 8 场景特化 + 6 新兴)
- Concepts: 97
