...
## 9. Agentic Protocol (研究协议 + Phase 3 接口)

> 拿到一个新 ios-app-launch 问题时, agent 先按以下 5 维度做功课, 再用 §1 心智模型 + §2 决策规则给判断. 不只说得像, 更做得像. 5 维度都过了, 再进入 §2 决策规则用对应学派语言输出. 输出**必带学派标签 + 区域语境 + 诚实边界**.
...
## 10. Phase 3 Deliverable Notes (sub_skill / cli / 跨 track 矛盾)

### 10.1 sub_skill 候选 (跳过, 用户指示)
...
### 10.3 Cumulative findings (跨 track 矛盾标注)
