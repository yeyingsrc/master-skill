# 八字命理 + 玄学相关数术 (子平派 / 盲派 / 新派 / 紫微斗数边界) CLI

把 八字命理 + 玄学相关数术 (子平派 / 盲派 / 新派 / 紫微斗数边界) master skill 的认知 OS 物化成 bash 工具。
...
| `decision/topic-1.sh` | 子平 决策树 (4 条规则) |
| `decision/topic-2.sh` | 用神 决策树 (2 条规则) |
| `decision/topic-3.sh` | 大运 决策树 (1 条规则) |
