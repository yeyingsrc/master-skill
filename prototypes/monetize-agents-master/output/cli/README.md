# 用 AI agent 赚钱 / agent 商业化 (创业 + 副业 + 咨询 + indie hacker) CLI

把 用 AI agent 赚钱 / agent 商业化 (创业 + 副业 + 咨询 + indie hacker) master skill 的认知 OS 物化成 bash 工具。
...
| `decision/trigger.sh` | Trigger 决策树 (10 条规则) |
